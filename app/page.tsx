      ...
      <div className={styles.header} style={{
        ...
        {editingLp ? (
          <div className={styles.flexGap}>
             ...
             <button onClick={() => { if (editingLp?.customDomain) { window.open(`https://${editingLp.customDomain}`, '_blank'); } else if (editingLp?.slug) { window.open(`/${editingLp.slug}`, '_blank'); } }} disabled={!editingLp?.slug} className={`${styles.btn} ${styles.btnSecondary}`} style={{display:'flex', alignItems:'center', gap:4}}>
